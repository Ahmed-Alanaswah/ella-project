<template>
  <div class="top-offers bg-grey-lighten-4 py-10">
    <v-container fluid>
      <v-row>
          ...
          <v-hover v-slot="{ isHovering, props }">
            ...
            >
              <img
                ...
                :style="` width: 100%  ; height: 100% ;transition:0.5s all ease-in-out ; scale: ${
                  isHovering ? 1.1 : 1
                }`"
                alt=""
              />
      ...
      <v-row class="mt-9">
        <v-col cols="6" class="mt-3 pr-5 py-0">
          <v-hover v-slot="{ isHovering, props }">
            <div
              class="parent"
              v-bind="props"
        ...
        <v-col cols="6" class="mt-3 pl-5 py-0">
          <v-hover v-slot="{ isHovering, props }">
            <div
              class="parent"
              v-bind="props"
