<template>
  <div class="nav-bar">
    <v-app-bar prominent color="#02218f" height="fit-content" absolute="">
      <v-container fluid>
        <v-row>
          <v-col cols="3">
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              >
                ...
                <span style="color: #ffb547" class="mt-1">Card</span>
              </div>
            </div>
          </v-col>
        </v-row>
      ...
      <!-- <v-app-bar-nav-icon @click.stop="emitEvent"></v-app-bar-nav-icon> -->
    </v-app-bar>
  </div>
</template>
